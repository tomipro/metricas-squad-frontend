...
describe('useOperations Hook', () => {
  ...
  it('should return loading state initially', () => {
    ...
    mockedAnalyticsService.getTimeToComplete.mockReturnValue(
      Promise.resolve(mockOperationsApiResponses.timeToComplete)
    );
    ...
    expect(result.current.timeToComplete.isLoading).toBe(true);
  ...
  it('should return success state with data', async () => {
    ...
    expect(result.current.timeToComplete.data).toEqual(mockOperationsApiResponses.timeToComplete);
  ...
  it('should return error state when API calls fail', async () => {
    ...
    mockedAnalyticsService.getTimeToComplete.mockRejectedValue(error);
    ...
    expect(result.current.timeToComplete.isError).toBe(true);
  ...
  it('should handle partial API failures', async () => {
    ...
    expect(result.current.timeToComplete.isError).toBe(false);
  ...
  it('should use default days parameter when not provided', () => {
    ...
    expect(mockedAnalyticsService.getTimeToComplete).toHaveBeenCalledWith(7);
